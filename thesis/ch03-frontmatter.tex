...
\begin{figure}[htbp]
\centering\includegraphics[scale=0.5]{SCC}
...
\begin{figure}[htbp]
\centering\includegraphics[scale=0.5]{DAG}
...
\end{algorithm} 
\begin{figure}[htbp]
\centering\includegraphics[scale=0.5]{Union}
...
为以后直接或者间接引用节点的操作加速。
\begin{figure}[htbp]
\centering\includegraphics[scale=0.5]{Find}
